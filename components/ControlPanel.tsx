...
const TaskListViewer: React.FC<{ tasks: any[] }> = ({ tasks }) => {
    return (
        <div className="flex-1 bg-[#050505] border border-emerald-900/30 rounded p-4 overflow-y-auto custom-scrollbar font-mono text-sm mb-4">
                ...
                {appMode === 'refine' ? (
                    <>
                        ...
                        {viewMode === 'edit' ? (
                            <textarea
                                ...
                                className="flex-1 bg-[#080a08] border border-emerald-900/30 rounded p-3 text-sm font-mono text-emerald-100 focus:outline-none focus:border-emerald-700 resize-none mb-4 custom-scrollbar"
                    ...
                    <>
                        ...
                        {manifestation ? (
                            ...
                            <div className="flex-1 bg-[#050505] border border-emerald-900/30 rounded p-4 flex flex-col items-center justify-center text-emerald-800/50 gap-4 mb-4">
                                ...
                                {projectPlan.length > 0 && (
                                    <div className="grid grid-cols-2 gap-2">
                                        <button
                                            ...
                                            onMouseEnter={() => playHover()}
                                            className="py-2 rounded font-bold text-[10px] tracking-widest transition-all flex items-center justify-center gap-2 bg-emerald-900/20 text-emerald-400 border border-emerald-800 hover:bg-emerald-900/40"
                                        >
                                            <Sparkles className="w-3 h-3" />
                                            TRANSFORM
                                        </button>
                                        <button
                                            onClick={() => { playClick(); engine.downloadProject(); }}
                                            onMouseEnter={() => playHover()}
                                            className="py-2 rounded font-bold text-[10px] tracking-widest transition-all flex items-center justify-center gap-2 bg-blue-900/20 text-blue-400 border border-blue-800 hover:bg-blue-900/40"
                                        >
